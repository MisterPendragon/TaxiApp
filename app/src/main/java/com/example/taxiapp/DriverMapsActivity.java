...
public class DriverMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void signOutDriver() {
        ...
        Intent intent = new Intent(DriverMapsActivity.this,Choose_Mode_Activity.class);
        ...
        case LocationSettingsStatusCodes
            ...
            try {
                ...
                resolvableApiException.
                        startResolutionForResult(DriverMapsActivity.this,CHECK_SETTINGS_CODE);
    ...
    private void updateLocationUI() {
        if(currentLocation != null) {
            ...
            DatabaseReference drivers = FirebaseDatabase.getInstance().getReference().child("drivers");
            drivers.setValue(true);// Для проверки работоспосб.узла
